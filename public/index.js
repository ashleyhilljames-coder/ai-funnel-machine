document.addEventListener('DOMContentLoaded', () =>{
 ...
 const tabDevLogs = document.getElementById('tab-dev-logs');
 const tabOpsView = document.getElementById('tab-ops-view');

 if (tabDevLogs && tabOpsView && terminalLog && operationsLog) {
 tabDevLogs.addEventListener('click', () => {
 tabDevLogs.classList.add('active');
 tabDevLogs.style.background = 'rgba(255,255,255,0.08)';
 tabDevLogs.style.color = '#fff';
 tabOpsView.classList.remove('active');
 tabOpsView.style.background = 'transparent';
 tabOpsView.style.color = 'var(--text-secondary)';
 terminalLog.classList.remove('hidden');
 terminalLog.style.display = 'flex';
 operationsLog.classList.add('hidden');
 operationsLog.style.display = 'none';
 });

 tabOpsView.addEventListener('click', () => {
 tabOpsView.classList.add('active');
 tabOpsView.style.background = 'rgba(255,255,255,0.08)';
 tabOpsView.style.color = '#fff';
 tabDevLogs.classList.remove('active');
 tabDevLogs.style.background = 'transparent';
 tabDevLogs.style.color = 'var(--text-secondary)';
 terminalLog.classList.add('hidden');
 terminalLog.style.display = 'none';
 operationsLog.classList.remove('hidden');
 operationsLog.style.display = 'flex';
 });
 }

 const addOpsCard = (html) => {
 if (!operationsLog) return;
 const wrapper = document.createElement('div');
 wrapper.innerHTML = html.trim();
 const card = wrapper.firstChild;
 operationsLog.appendChild(card);
 ...
 if (operationsLog) operationsLog.innerHTML = '';
 ...
 // Ingest ops card
 addOpsCard(`
    <div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); border-radius: 6px; padding: 12px; display: flex; align-items: center; gap: 15px; animation: fadeInUp 0.4s ease forwards;">
      <div style="background: rgba(44, 238, 118, 0.1); color: #2CEE76; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.1rem; font-weight: bold;">✓</div>
      <div style="flex: 1;">
        <div style="font-weight: 600; color: #fff; font-size: 0.85rem;">Lead Ingested & Schema Verified</div>
        <div style="color: var(--text-secondary); font-size: 0.75rem;">Name: ${sbName.value} | Company: ${sbCompany.value}</div>
      </div>
      <span style="font-size: 0.75rem; color: #2CEE76; font-weight: bold;">Ingested</span>
    </div>
  `);
 ...
 addOpsCard(`
      <div style="background: rgba(239, 68, 68, 0.05); border: 1px solid rgba(239, 68, 68, 0.15); border-radius: 6px; padding: 12px; display: flex; align-items: center; gap: 15px; animation: fadeInUp 0.4s ease forwards; margin-top: 5px;">
        <div style="background: rgba(239, 68, 68, 0.1); color: #ef4444; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.1rem; font-weight: bold;">✕</div>
        <div style="flex: 1;">
          <div style="font-weight: 600; color: #fff; font-size: 0.85rem;">Pipeline Terminated - Spam Detected</div>
          <div style="color: var(--text-secondary); font-size: 0.75rem;">Score: 5/100 (Unsolicited Marketing Match)</div>
        </div>
        <span style="font-size: 0.75rem; color: #ef4444; font-weight: bold;">Blocked</span>
      </div>
    `);
 ...
 addOpsCard(`
      <div style="background: rgba(239, 68, 68, 0.05); border: 1px solid rgba(239, 68, 68, 0.15); border-radius: 6px; padding: 12px; display: flex; align-items: center; gap: 15px; animation: fadeInUp 0.4s ease forwards; margin-top: 5px;">
        <div style="background: rgba(239, 68, 68, 0.1); color: #ef4444; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.1rem; font-weight: bold;">✕</div>
        <div style="flex: 1;">
          <div style="font-weight: 600; color: #fff; font-size: 0.85rem;">Pipeline Terminated - Low Budget</div>
          <div style="color: var(--text-secondary); font-size: 0.75rem;">Score: 45/100 (Threshold limit: $5,000)</div>
        </div>
        <span style="font-size: 0.75rem; color: #ef4444; font-weight: bold;">Blocked</span>
      </div>
    `);
 ...
 addOpsCard(`
      <div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); border-radius: 6px; padding: 12px; display: flex; align-items: center; gap: 15px; animation: fadeInUp 0.4s ease forwards; margin-top: 5px;">
        <div style="background: rgba(44, 238, 118, 0.1); color: #2CEE76; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.85rem; font-weight: bold;">92</div>
        <div style="flex: 1;">
          <div style="font-weight: 600; color: #fff; font-size: 0.85rem;">Qualified by Claude AI</div>
          <div style="color: var(--text-secondary); font-size: 0.75rem;">Score: 92/100 | Target Budget: ${sbBudget.value}</div>
        </div>
        <span style="font-size: 0.75rem; color: #2CEE76; font-weight: bold;">Passed</span>
      </div>
    `);
 ...
 addOpsCard(`
      <div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); border-radius: 6px; padding: 12px; display: flex; align-items: center; gap: 15px; animation: fadeInUp 0.4s ease forwards; margin-top: 5px;">
        <div style="background: rgba(44, 238, 118, 0.1); color: #2CEE76; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.1rem; font-weight: bold;">✓</div>
        <div style="flex: 1;">
          <div style="font-weight: 600; color: #fff; font-size: 0.85rem;">Brand Fit Evaluation Approved</div>
          <div style="color: var(--text-secondary); font-size: 0.75rem;">Confidence: 0.88/1.00 | Technical stack alignment confirmed</div>
        </div>
        <span style="font-size: 0.75rem; color: #2CEE76; font-weight: bold;">Approved</span>
      </div>
    `);
 ...
 addOpsCard(`
      <div style="background: rgba(44, 238, 118, 0.05); border: 1px solid rgba(44, 238, 118, 0.15); border-radius: 6px; padding: 12px; display: flex; align-items: center; gap: 15px; animation: fadeInUp 0.4s ease forwards; margin-top: 5px;">
        <div style="background: rgba(44, 238, 118, 0.1); color: #2CEE76; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.1rem; font-weight: bold;">📅</div>
        <div style="flex: 1;">
          <div style="font-weight: 600; color: #fff; font-size: 0.85rem;">Discovery Meeting Scheduled</div>
          <div style="color: var(--text-secondary); font-size: 0.75rem;">Event: "Syncro Scale Discovery Call - ${sbCompany.value}"</div>
        </div>
        <span style="font-size: 0.75rem; color: #2CEE76; font-weight: bold;">Booked</span>
      </div>
    `);
 ...
 addOpsCard(`
      <div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); border-radius: 6px; padding: 12px; display: flex; align-items: center; gap: 15px; animation: fadeInUp 0.4s ease forwards; margin-top: 5px;">
        <div style="background: rgba(255,255,255,0.05); color: #fff; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1rem;">💬</div>
        <div style="flex: 1;">
          <div style="font-weight: 600; color: #fff; font-size: 0.85rem;">Operational alerts dispatched</div>
          <div style="color: var(--text-secondary); font-size: 0.75rem;">Slack lead card posted | CRM profile synced successfully</div>
        </div>
        <span style="font-size: 0.75rem; color: var(--text-muted);">Dispatched</span>
      </div>
    `);
